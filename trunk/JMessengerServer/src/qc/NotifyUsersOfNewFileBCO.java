...
public class NotifyUsersOfNewFileBCO implements ControlObject {
	...
	public Object handleIt(ArrayList<Object> arg0) {
		...
		MessageBean message = new MessageBean("SERVER", curUser.getUsername() +" has uploaded " + file.getFileName());
